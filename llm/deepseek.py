...
class ColumnParallelLinear(Linear):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        """
        print(self.weight.shape, "weight.shape")
...
class MLA(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.n_local_heads = args.n_heads // world_size # 16 / 1
        ...
        self.qk_head_dim = args.qk_nope_head_dim + args.qk_rope_head_dim #128是attention维度，64是rope维度
        self.v_head_dim = args.v_head_dim #128

        if self.q_lora_rank == 0:
            self.wq = ColumnParallelLinear(self.dim, self.n_heads * self.qk_head_dim) #[2048, 16 * (128 + 64)] 128是attention维度，64是rope维度
        else:
...
class Transformer(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.embed = ParallelEmbedding(args.vocab_size, args.dim) #[102400, 2048]
